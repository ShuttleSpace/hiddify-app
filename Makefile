...
ifeq ($(CHANNEL),prod)
	CORE_URL=https://github.com/ShuttleSpace/hiddify-core/releases/download/v$(core.version)
else
	CORE_URL=https://github.com/ShuttleSpace/hiddify-core/releases/download/draft
endif
