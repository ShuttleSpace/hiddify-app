...
class AppTheme {
  AppTheme(this.mode, this.fontFamily, {this.seedColor});
  ...
  ThemeData lightTheme(ColorScheme? lightColorScheme) {
    final ColorScheme scheme =
        lightColorScheme ?? ColorScheme.fromSeed(seedColor: seedColor ?? const Color(0xFF293CA0));
    return ThemeData(
      useMaterial3: true,
      colorScheme: scheme,
  ...
  ThemeData darkTheme(ColorScheme? darkColorScheme) {
    final ColorScheme scheme =
        darkColorScheme ??
        ColorScheme.fromSeed(seedColor: seedColor ?? const Color(0xFF293CA0), brightness: Brightness.dark);
    return ThemeData(
      useMaterial3: true,
      colorScheme: scheme,
