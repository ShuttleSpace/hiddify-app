...
final $typed_data.Uint8List domainStrategyDescriptor =
    $convert.base64Decode('Cg5Eb21haW5TdHJhdGVneRIJCgVhc19pcxAAEg8KC3ByZWZlcl9pcHY0EAESDwoLcHJlZmVyX2'
...
final $typed_data.Uint8List hiddifyOptionsDescriptor =
    $convert.base64Decode('Cg5IaWRkaWZ5T3B0aW9ucxIsChJlbmFibGVfZnVsbF9jb25maWcYASABKAhSEGVuYWJsZUZ1bG'
...
final $typed_data.Uint8List dNSOptionsDescriptor =
    $convert.base64Decode('CgpETlNPcHRpb25zEiwKEnJlbW90ZV9kbnNfYWRkcmVzcxgBIAEoCVIQcmVtb3RlRG5zQWRkcm'
...
final $typed_data.Uint8List inboundOptionsDescriptor =
    $convert.base64Decode('Cg5JbmJvdW5kT3B0aW9ucxIdCgplbmFibGVfdHVuGAEgASgIUgllbmFibGVUdW4SLAoSZW5hYm'
...
final $typed_data.Uint8List uRLTestOptionsDescriptor =
    $convert.base64Decode('Cg5VUkxUZXN0T3B0aW9ucxIuChNjb25uZWN0aW9uX3Rlc3RfdXJsGAEgASgJUhFjb25uZWN0aW'
...
final $typed_data.Uint8List routeOptionsDescriptor =
    $convert.base64Decode('CgxSb3V0ZU9wdGlvbnMSLwoTcmVzb2x2ZV9kZXN0aW5hdGlvbhgBIAEoCFIScmVzb2x2ZURlc3'
...
final $typed_data.Uint8List tLSTricksDescriptor =
    $convert.base64Decode('CglUTFNUcmlja3MSJwoPZW5hYmxlX2ZyYWdtZW50GAEgASgIUg5lbmFibGVGcmFnbWVudBI9Cg'
...
final $typed_data.Uint8List muxOptionsDescriptor =
    $convert.base64Decode('CgpNdXhPcHRpb25zEhYKBmVuYWJsZRgBIAEoCFIGZW5hYmxlEhgKB3BhZGRpbmcYAiABKAhSB3'
...
final $typed_data.Uint8List warpOptionsDescriptor =
    $convert.base64Decode('CgtXYXJwT3B0aW9ucxIOCgJpZBgBIAEoCVICaWQSHwoLZW5hYmxlX3dhcnAYAiABKAhSCmVuYW'
...
final $typed_data.Uint8List warpWireguardConfigDescriptor =
    $convert.base64Decode('ChNXYXJwV2lyZWd1YXJkQ29uZmlnEh8KC3ByaXZhdGVfa2V5GAEgASgJUgpwcml2YXRlS2V5Ei'
...
final $typed_data.Uint8List ruleDescriptor =
    $convert.base64Decode('CgRSdWxlEiAKDHJ1bGVfc2V0X3VybBgBIAEoCVIKcnVsZVNldFVybBIYCgdkb21haW5zGAIgAS'
